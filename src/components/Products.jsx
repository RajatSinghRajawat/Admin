...
const Products = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const response = await fetch('https://backend.readymadewall.in/api/products');
        if (!response.ok) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch("https://backend.readymadewall.in/api/products/createProduct", requestOptions);
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`https://backend.readymadewall.in/api/products/${selectedProduct._id || selectedProduct.id}`, {
        method: 'PUT',
        headers: {
  ...
  const confirmDelete = async () => {
    ...
    try {
      const token = localStorage.getItem('token');
      const response = await fetch(`https://backend.readymadewall.in/api/products/${productToDelete._id || productToDelete.id}`, {
        method: 'DELETE',
        headers: {
          'Authorization': `Bearer ${token}`
        }
